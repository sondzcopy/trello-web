...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardsAPI(searchPath)
      .then(res => {
        ...
        // lưu ý về việc set loading về false luôn phải chạy trong finally để dù có lỗi hay ko thì ko hiện loading nữa
        setLoading(false)
      })
  }
  // Đọc hàm handleInputSeachChane ở trên vào useDebounceFn và cho delay khoảng 1s sau khi dừng gõ phím thì mới chạy Fun
  const debounceSeachBoard = useDebounceFn(handleInputSearchChange, 1000)
  ...
  return (
    <Autocomplete
      ...
      onInputChange={debounceSeachBoard}
